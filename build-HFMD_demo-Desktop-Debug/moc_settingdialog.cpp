...
#include "../HFMD_demo/settingdialog.h"
...
QT_MOC_LITERAL(4, 34, 12)
    ...
    "settingDialog\0sendConfig\0\0CConfig\0"
    "changeConfig\0"
};
...
void settingDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sendConfig((*reinterpret_cast< CConfig(*)>(_a[1]))); break;
        case 1: _t->changeConfig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->changeConfig((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (settingDialog::*_t)(CConfig );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&settingDialog::sendConfig)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void settingDialog::sendConfig(CConfig _t1)
{
