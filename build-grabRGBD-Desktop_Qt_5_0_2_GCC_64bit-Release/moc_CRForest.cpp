...
QT_MOC_LITERAL(11, 150, 3),
QT_MOC_LITERAL(12, 154, 5),
QT_MOC_LITERAL(13, 160, 27),
QT_MOC_LITERAL(14, 188, 13),
QT_MOC_LITERAL(15, 202, 8)
    },
    ...
    "int*\0detection\0cv::Mat*\0rgb\0depth\0"
...
void CRForest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->detection((*reinterpret_cast< cv::Mat*(*)>(_a[1])),(*reinterpret_cast< cv::Mat*(*)>(_a[2]))); break;
        ...
        case 2:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< cv::vector<cv::Mat*> >(); break;
            }
            break;
        }
        ...
        {
            typedef void (CRForest::*_t)(std::vector<detectionResult*> );
...
// SIGNAL 0
void CRForest::detectedResult(std::vector<detectionResult*> _t1)
{
